      ...
      <div v-if="!isEditing" class="space-y-4">
        <div 
          ...
          :class="[
            ...
            item.is_pay == 1 ? 'border-emerald-500 ring-1 ring-emerald-500/50 shadow-lg shadow-emerald-500/10' : 'border-slate-700'
          ]"
        >
          <div v-if="item.is_pay == 1" class="absolute top-0 right-0 bg-emerald-500 p-1 rounded-bl-lg">
          ...
          <div class="flex items-center gap-3 mb-4">
            <div>
              <p v-if="item.is_pay == 1" class="text-[10px] text-emerald-500 font-bold uppercase tracking-wider">使用中</p>
            </div>
          </div>
...
const bankOptions = [{name:'SEAB',code:'SeABank'}, {name:'Vikki',code:'Vikki'}, {name:'OCB',code:'OCB'}, {"code": "PGBank","name": "PGB"},{"code": "VietinBank","name": "ICB"}, {"code": "HDBank","name": "HDB"}];
